...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 16, 2021 at 02:39 PM
...
--
CREATE DATABASE IF NOT EXISTS `electronic_session` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
...
(28, 'dadas', 1, 0, '', '2021-09-16 12:38:05', 0, '2021-09-16 12:38:05', '2021-09-16 12:38:05');
...
DROP TABLE IF EXISTS `user_agenda_item_access`;
...
--
ALTER TABLE `voting`
  MODIFY `idvoting` int(11) NOT NULL AUTO_INCREMENT;
